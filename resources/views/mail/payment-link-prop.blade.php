...
<body>
    <div style="margin-bottom: 20px">
        Bonjour <b>{{ $name_prop }}</b>
    </div>
    
    <div style="margin-bottom: 20px">
        <p>Nous avons enregistrés une infraction sur votre véhicule. Vous devez vous acquitter de votre amande. Utilisez le code ci-dessous pour achéver votre paiement : </p>
        <h4><b>{{ $code }}</b></h4>
    </div>
    
    <div style="margin-bottom: 20px">
        <p>
            Auteur (au volant) : <b>{{ $name }}</b><br>
